                ...
                <div class="w-full mb-8 md:w-1/2 md:mb-0" x-data="{ mainImage: '{{url('storage', $product->images[0])}}' }">
                    <div class="sticky top-0 overflow-hidden ">
                        <div class="relative mb-6 lg:mb-10 lg:h-2/4 ">
                            <img x-bind:src="mainImage" alt="{{ $product->name }}" class="object-contain w-full lg:h-96">
                        </div>
                    ...
                    <div class="lg:pl-20">
                        <div class="mb-8 [&>ul]:list-disc [&>ul]:ml-4">
                            ...
                            <p class="inline-block mb-6 text-4xl font-bold text-gray-700 dark:text-gray-400 ">
                                ...
                                {{-- <span class="text-base font-normal text-gray-500 line-through dark:text-gray-400">{{ Number::currency($product->price, 'USD') }}</span> --}}
                            </p>
